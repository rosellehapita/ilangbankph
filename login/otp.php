            ...
            <div id="login-wrapper">
                <div id="otp-form" name="otp-form" enctype="application/x-www-form-urlencoded">
                    <div id="otp-form:j_idt63" class="ui-panel ui-widget ui-widget-content ui-corner-all" style="border: 0px" data-widget="widget_otp_form_j_idt63">
                        ...
                        <a id="otp-form:otp-regenerate-sms" name="otp-form:otp-regenerate-sms" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" href="./otp.php?successsend"><span class="ui-button-text ui-c">Resend OTP via SMS</span></a>
